...
> **Agent operating map:** [`.claude/SKILL-MAP.md`](.claude/SKILL-MAP.md) — the one-page router that tells future agents which specialist skill to auto-consult for legal work, design, career documents, Mīzān, Roohe Iqbal, source ingestion and repository governance.
