...
""",
    contact=f"""        {a('mailto:' + EMAIL, EMAIL)}&nbsp;&middot;&nbsp;{tel(PRO_TEL)}&nbsp;&middot;&nbsp;<span style="color:{FAINT};">Newark, NJ</span><br>
        ...
        {a('https://github.com/MalikAI-786', 'Instrument and models')}<span style="color:{FAINT};">, open &middot; </span>{a(SITE + 'newsletter.html', 'Proof Over Promise')}<span style="color:{FAINT};">, the newsletter</span>""")
...
""",
    contact=f"""        {a('mailto:' + EMAIL, EMAIL)}&nbsp;&middot;&nbsp;{tel(PRO_TEL)}<br>
        ...
        {a(SITE + 'newsletter.html', 'Proof Over Promise')}<span style="color:{FAINT};">, a newsletter on AI governance and professional judgment</span>""")
